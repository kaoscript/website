...
|  hashes  |  `.ksh`   | includes all the used files with their hashes              | `.index.ks.v8-v6.6.ksh` |
| metadata |  `.ksm`   | include the metadata use when importing the current module | `.index.ks.v8-v6.6.ksm` |
