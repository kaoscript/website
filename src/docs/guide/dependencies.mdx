...
expressive-type = (
	([(final | sealed)] [abstract] | [system]) *class-type*
	|
	[async] [func] *func-type*
	|
	[sealed] *namespace-type*
	|
	[sealed] *identifier*[: *type*]
)
...
class-type = class *identifier*["<" *generic-type* ">"] [extends *identifier*] [{
	...
}]

func-type = *identifier* '(' [[*parameter1*] [, [*parameter2*] ... [, [*parameterN*]]] ')' [: *type*] [~ *class1* [, *class2* ... [, *classN*]]]
