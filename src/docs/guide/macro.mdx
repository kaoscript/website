...
| reification |  reification   |                      description                      | ast | auto |
| :---------: | :------------: | :---------------------------------------------------: | :-: | :--: |
...
- For AST parameters, `#(...)` prints out the AST tree of the parameters.
- For auto-evaluated parameters, `#(...)` is the same as `#e(...)`.
...
| Object  | `{x: '42'}` | `{x: '42'}` | `{x: '42'}` | `{x: '42'}` | `{x: '42'}` |
